...
function ProductOptionsModal({
  ...
  const detectedFilling =
    item.name?.includes("Ø³ÙƒØ§Ù„ÙˆØ¨")
      ? "Ø³ÙƒØ§Ù„ÙˆØ¨"
      : item.name?.includes("ÙƒØ¨Ø¯Ø©")
        ? "ÙƒØ¨Ø¯Ø©"
        : item.name?.includes("Ù…ÙŠÙƒØ³")
          ? "Ù…ÙŠÙƒØ³"
          : null;
  ...
  const fillingType = isSpecial
    ? ["Ø³ÙƒØ§Ù„ÙˆØ¨", "ÙƒØ¨Ø¯Ø©", "Ù…ÙŠÙƒØ³"].includes(type)
      ? type
      : detectedFilling
    : detectedFilling;
      ...
      >
        <div className="product-options__header">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Ø¥ØºÙ„Ø§Ù‚ Ø§Ù„Ù†Ø§Ã™ÂØ°Ø©"
          >
            Ã—
          </button>
        </div>
        ...
        {isSpecial && (
          <>
            ...
            <div className="product-options__section">
              <h3>Ø§Ù„Ø¥Ø¶Ø§Ã™ÂØ© Ø§Ù„Ø®Ø§ØµØ©</h3>
              ...
              <div className="product-options__choices">
                ...
                >
                  ...
                  <span>
                    ÙƒÙˆÙ…ÙˆØ¨ÙŠØ± â€” {formatPrice(100)}
                  </span>
                </label>
              </div>
            </div>
        ...
        {fillingType && (
          <div className="product-options__section">
            <h3>Ø¥Ø¶Ø§Ã™ÂØ§Øª Ù…Ø¬Ø§Ù†ÙŠØ©</h3>
        ...
        <div className="cart-customer-form">
          <label>
            ...
            <input
              ...
              placeholder="Ù…Ø«Ø§Ù„: Ø£Ø­Ù…Ø¯ Ø¨Ù„Ø­Ø§Ø¬"
            />
          </label>
          ...
          <label>
            ...
            <input
              ...
              placeholder="Ù…Ø«Ø§Ù„: Ø­ÙŠ Ø§Ù„Ù†ØµØ±ØŒ Ø§Ù„Ø¹Ù„Ù…Ø©"
            />
          </label>
...
export default function App() {
  ...
  async function loginCustomer(event) {
    ...
    if (!supabase) {
      setCustomerLoginError(
        "Ø®Ø¯Ù…Ø© ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø­Ø³Ø§Ø¨ ØºÙŠØ± Ù…ØªØ§Ø­Ø© Ø­Ø§Ù„ÙŠØ§Ù‹."
      );
      return;
    }
    ...
    if (error || !data?.success) {
      setCustomerLoginError(
        data?.message ||
          "ØªØ¹Ø°Ø± Ø¥Ù†Ø´Ø§Ø¡ Ø§Ù„Ø­Ø³Ø§Ø¨. Ø­Ø§ÙˆÙ„ Ù…Ø±Ø© Ø£Ø®Ø±Ù‰."
      );
      return;
    }
  ...
  async function loginUnified(event) {
    ...
    if (!supabase) {
      setAuthLoginError(
        "Ø®Ø¯Ù…Ø© ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„ ØºÙŠØ± Ù…ØªØ§Ø­Ø© Ø­Ø§Ù„ÙŠØ§Ù‹."
      );
      return;
    }
    ...
    if (error) {
      ...
      setAuthLoginError(
        "ØªØ¹Ø°Ø± Ø§Ù„Ø§ØªØµØ§Ù„ Ø¨Ø®Ø¯Ù…Ø© ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„."
      );
    ...
    if (!result.success) {
      setAuthLoginError(
        result.message ||
          "Ø±Ù‚Ù… Ø§Ù„Ù‡Ø§ØªÃ™Â Ø£Ùˆ ÙƒÙ„Ù…Ø© Ø§Ù„Ù…Ø±ÙˆØ± ØºÙŠØ± ØµØ­ÙŠØ­Ø©."
      );
    ...
    if (
      ...
      setAuthLoginError(
        "Ù‡Ø°Ø§ Ø§Ù„Ø­Ø³Ø§Ø¨ Ù„Ø§ ÙŠÙ…Ù„Ùƒ ØµÙ„Ø§Ø­ÙŠØ© Ø§Ù„Ø¯Ø®ÙˆÙ„ Ø¥Ù„Ù‰ Ù‡Ø°Ù‡ Ø§Ù„ÙˆØ§Ø¬Ù‡Ø©."
      );
  ...
  async function saveAuthDriverPhone(event) {
    ...
    if (
      ...
      setAuthPhoneError(
        "Ø¬Ù„Ø³Ø© Ø§Ù„Ø³Ø§Ø¦Ù‚ ØºÙŠØ± ØµØ§Ù„Ø­Ø©. Ø£Ø¹Ø¯ ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„."
      );
      return;
    }
    ...
    if (!authSessionToken) {
      setAuthPhoneError(
        "Ø¬Ù„Ø³Ø© Ø§Ù„Ø³Ø§Ø¦Ù‚ Ù…Ù†ØªÙ‡ÙŠØ©. Ø£Ø¹Ø¯ ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„."
      );
      return;
    }
    ...
    if (!supabase) {
      setAuthPhoneError(
        "Ø®Ø¯Ù…Ø© Ø§Ù„Ø³Ø§Ø¦Ù‚ ØºÙŠØ± Ù…ØªØ§Ø­Ø© Ø­Ø§Ù„ÙŠØ§Ù‹."
      );
      return;
    }
  ...
  async function checkoutOrder({
    ...
    const message = [
      ...
      "",
      `Ø§Ù„Ø³Ù„Ø§Ù… Ø¹Ù„ÙŠÙƒÙ…ØŒ Ø£Ø±ØºØ¨ Ã™ÂÙŠ Ø·Ù„Ø¨ Ù…Ù† ${storeConfig.name}`,
      "",
      "ØªÃ™ÂØ§ØµÙŠÙ„ Ø§Ù„Ø·Ù„Ø¨:",
      ...lines,
      "",
      `Ù…Ø¬Ù…ÙˆØ¹ Ø§Ù„Ù…Ù†ØªØ¬Ø§Øª: ${formatPrice(
        subtotal
      )}`,
      `Ù…ØµØ§Ø±ÙŠÃ™Â Ø§Ù„ØªÙˆØµÙŠÙ„: ${formatPrice(
        delivery
      )}`,
      `Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹ Ø§Ù„Ù†Ù‡Ø§Ø¦ÙŠ: ${formatPrice(
        total
      )}`,
      "",
    ...
    <>
      ...
      {!isStaff && (
        <section className="story">
          <p className="story__text balance">
            ÙŠØªÙ… Ø¥Ø¹Ø¯Ø§Ø¯ ÙƒÙ„ Ø´Ø¨Ø§ØªÙŠ ÙˆÙ…Ù„Ã™ÂÙˆÃ™Â Ø¹Ù†Ø¯
          ...
          >
            <div className="customer-login__header">
              <div>
                ...
                <p>
                  {customer
                    ? "Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø­Ø³Ø§Ø¨Ùƒ Ù…Ø­Ã™ÂÙˆØ¸Ø© ÙˆÙŠÙ…ÙƒÙ†Ùƒ Ø§Ø³ØªØ®Ø¯Ø§Ù…Ù‡Ø§ Ø¹Ù†Ø¯ Ø§Ù„Ø·Ù„Ø¨."
                    : "Ø£Ù†Ø´Ø¦ Ø­Ø³Ø§Ø¨Ùƒ Ø¨Ø¥Ø¯Ø®Ø§Ù„ Ø§Ù„Ø§Ø³Ù… ÙˆØ±Ù‚Ù… Ø§Ù„Ù‡Ø§ØªÃ™Â."}
                </p>
              </div>
              ...
              <div>
                <h2 id="auth-login-title">
                  {authStep === "dashboard"
                    ? authUser?.role ===
                      "owner"
                      ? "ðŸ‘‘ Ù„ÙˆØ­Ø© Ø§Ù„Ù…Ø§Ù„Ùƒ"
                      : "ðŸšš Ù„ÙˆØ­Ø© Ø§Ù„Ø³Ø§Ø¦Ù‚"
                    : authStep ===
                        "phone"
                      ? "ðŸ“± Ø±Ù‚Ù… Ù‡Ø§ØªÃ™Â Ø§Ù„Ø³Ø§Ø¦Ù‚"
                      : "Ã°Å¸â€Â ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„"}
                </h2>
                ...
                <p>
                  {authStep === "dashboard"
                    ...
                    : authStep === "phone"
                      ? "Ø£Ø¯Ø®Ù„ Ø±Ù‚Ù… Ù‡Ø§ØªÃ™ÂÙƒ Ù„Ø¥ÙƒÙ…Ø§Ù„ Ø­Ø³Ø§Ø¨ Ø§Ù„Ø³Ø§Ø¦Ù‚."
                      : "Ø£Ø¯Ø®Ù„ Ø±Ù‚Ù… Ø§Ù„Ù‡Ø§ØªÃ™Â ÙˆÙƒÙ„Ù…Ø© Ø§Ù„Ù…Ø±ÙˆØ±."}
                </p>
              </div>
            ...
            {authStep === "phone" && (
              ...
              >
                <div className="driver-login__info">
                  ...
                  <br />
                  Ù„Ø¥ÙƒÙ…Ø§Ù„ Ø­Ø³Ø§Ø¨ Ø§Ù„Ø³Ø§Ø¦Ù‚ØŒ
                  ÙŠØ¬Ø¨ ØªØ³Ø¬ÙŠÙ„ Ø±Ù‚Ù… Ø§Ù„Ù‡Ø§ØªÃ™Â.
                </div>
                ...
                >
                  {authSavePhoneLoading
                    ? "Ø¬Ø§Ø±ÙŠ Ø­Ã™ÂØ¸ Ø§Ù„Ø±Ù‚Ù…..."
                    : "Ø­Ã™ÂØ¸ Ø±Ù‚Ù… Ø§Ù„Ù‡Ø§ØªÃ™Â"}
                </button>
              </form>
            )}
                    ...
                    <div className="driver-login__success">
                      ...
                      {ownerOrdersLoading
                        ...
                        : ownerOrdersToday !==
                          ...
                          : "ØªØ¹Ø°Ø± ØªØ­Ù…ÙŠÙ„ Ø¹Ø¯Ø¯ Ø§Ù„Ø·Ù„Ø¨Ø§Øª."}
                    </div>
                  )}
      ...
      {cart.length > 0 && (
        <button
          ...
          aria-label="Ã™ÂØªØ­ Ø³Ù„Ø© Ø§Ù„Ø·Ù„Ø¨"
        >
